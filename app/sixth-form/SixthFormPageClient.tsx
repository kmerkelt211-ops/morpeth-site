...
import {
  DEFAULT_SIXTH_FORM_MEDIA,
  type SixthFormMedia,
} from "../../lib/siteMediaLoaders"

type SixthFormPageClientProps = {
  initialMedia?: SixthFormMedia | null
}

export default function SixthFormPageClient({ initialMedia }: SixthFormPageClientProps) {
  ...
  const media = initialMedia ?? DEFAULT_SIXTH_FORM_MEDIA
