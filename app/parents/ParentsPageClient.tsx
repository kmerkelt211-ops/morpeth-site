...
export type PartialParentsResponse = Partial<{
...
type ParentsPageClientProps = {
  initialContent?: PartialParentsResponse | null;
};

export default function ParentsPageClient({ initialContent }: ParentsPageClientProps) {
  ...
  const [attendanceContent] = useState<ParentsAttendanceContent>(() =>
    mergeAttendanceContent(initialContent)
  );
